...
export const FIXED_TERM_BANK_ABI = [
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "indexed": false,
        "internalType": "enum FixedTermBank.Term",
        "name": "term",
        "type": "uint8"
      }
    ],
    ...
    "outputs": [
      {
        ...
        "internalType": "struct FixedTermBank.Deposit",
        "name": "",
        "type": "tuple"
      }
    ],
...
export const MOCK_USDT = {
  address: MOCK_USDT_ADDRESS,
  abi: MOCK_USDT_ABI,
  decimals: MOCK_USDT_DECIMALS,
} as const;

export const FIXED_TERM_BANK = {
  address: FIXED_TERM_BANK_ADDRESS,
  abi: FIXED_TERM_BANK_ABI,
} as const;

export const TERM_OPTIONS = [
  { value: 0, label: '1 Month', months: 1 },
  { value: 1, label: '6 Months', months: 6 },
  { value: 2, label: '1 Year', months: 12 },
  { value: 3, label: '3 Years', months: 36 },
] as const;
